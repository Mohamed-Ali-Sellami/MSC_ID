...
export const userRegister = createAsyncThunk("user/register", async (user, { rejectWithValue }) => {
  try {
    const response = await axios.post("https://msc-id-mohamed-alis-projects-8660c8bc.vercel.app", user);
...
export const userCurrent = createAsyncThunk("user/current", async (_, { rejectWithValue }) => {
  try {
    const response = await axios.get("https://msc-id-mohamed-alis-projects-8660c8bc.vercel.app", {
      headers: {
...
export const updateuser = createAsyncThunk("user/update", async ({ id, updatedData }, { rejectWithValue }) => {
  try {
    const response = await axios.put(`https://msc-id-mohamed-alis-projects-8660c8bc.vercel.app/user/${id}`, updatedData);
    return response.data;
  } catch (error) {
    console.error(error);
